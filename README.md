...
**Note:** The trained model  of MCF-Net *'./MCF_Net/result/DenseNet121\_v3\_v1.tar'* (~112MB) is provided by using [Git Large File Storage (LFS)](https://git-lfs.github.com).
